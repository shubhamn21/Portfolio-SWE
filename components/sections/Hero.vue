  ...
  <div class='hero is-fullheight'>
    <div class='hero-head section mt-6 pt-6'>
      <div class='hero-section'>
        ...
        <h1 class='title is-size-3-mobile'>Shubham Nimbalkar</h1>
        <h2 class='title is-size-3-mobile'>Software Engineer ML/Backend</h2>
        <div class='columns'>
          <div class='column is-5-fullhd is-6-widescreen is-7-desktop is-8-tablet is-12-mobile'>
            <p class='is-size-6 mt-5'>I am an enthusiastic software engineer with a passion for creating extraordinary
              software and apps. Right now I am developing with internal automation engineering framworks and delivering flawless dashboard for coverage analysis on the while I am working as <b>Software Engineer Intern position @ Apple</b>.
            </p>
          </div>
        </div>
